...
import { getProvinces, getOneUser, getCantons, updateUser } from 'services/http';
...
const Profile = () => {
    const { saveUSER, saveProvinces } = useContext(UserDataContext);
    ...
    useEffect(async () => {
        ...
        const user = await getOneUser(cookie.data);
    ...
    const handleSubmit = async (e) => {
        ...
        const cookie = getCookie();
        if (cookie) {
            const res = await updateUser(cookie.data, {
                id: user_id,
                avatar,
                first_name,
                last_name,
